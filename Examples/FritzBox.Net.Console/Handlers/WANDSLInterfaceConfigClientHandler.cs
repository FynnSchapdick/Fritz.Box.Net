...
namespace FritzBox.Net.Console.Handlers
{
    public class WANDSLInterfaceConfigClientHandler : ClientHandler
    {
        ...
        {
            this._client = device.GetServiceClient<WanDslInterfaceConfigClient>();
