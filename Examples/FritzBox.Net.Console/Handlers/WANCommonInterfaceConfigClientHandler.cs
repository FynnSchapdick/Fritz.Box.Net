...
namespace FritzBox.Net.Console.Handlers
{
    public class WANCommonInterfaceConfigClientHandler : ClientHandler
    {
        ...
        {
            this._client = device.GetServiceClient<WanCommonInterfaceConfigClient>();
        }
