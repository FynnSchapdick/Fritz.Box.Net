...
namespace FritzBox.Net.Console.Handlers
{
    public class LANEthernetInterfaceClientHandler : ClientHandler
    {
        ...
        {
            this._client = device.GetServiceClient<LanEthernetInterfaceClient>();
        }
