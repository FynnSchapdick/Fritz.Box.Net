...
namespace FritzBox.Net.Console.Handlers
{
    internal class LANHostConfigManagementClientHandler : ClientHandler
    {
        ...
        {
            this._client = device.GetServiceClient<LanHostConfigManagementClient>();
        }
