...
namespace FritzBox.Net.FritzBox.Clients.DeviceInfo
{
    /// <summary>
    ...
    public class DeviceInfoClient : FritzTr64Client
    {
        ...
        {
            XDocument document = await InvokeAsync("GetDeviceLog", null);            
        ...
        {
            XDocument document = await InvokeAsync("GetSecurityPort", null);
