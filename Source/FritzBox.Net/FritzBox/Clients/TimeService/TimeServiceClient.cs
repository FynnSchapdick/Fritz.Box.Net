...
namespace FritzBox.Net.FritzBox.Clients.TimeService
{
    /// <summary>
    ...
    public class TimeServiceClient : FritzTr64Client
    {
        ...
        {
            await InvokeAsync("SetNTPServers", new SoapRequestParameter("NewNTPServer1", ntpServer1.ToString()), new SoapRequestParameter("NewNTPServer2", ntpServer2.ToString()));
        }
    }
}
